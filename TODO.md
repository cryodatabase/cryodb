<Route path="/papers" component={Papers} /> - route done - page done - performance review done - zod and validation done
...
<Route path="/formulation/:id" component={FormulationDetailPage} /> - route done - page done - performance review done - zod and validation done
