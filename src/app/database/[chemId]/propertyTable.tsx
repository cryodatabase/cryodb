...
import { PropertiesResponse, AgentPropertyGeneric, Source } from "./page";
...
export const transformData = (data: PropertiesResponse): TransformedProperty[] => {
  ...
  const groupedByPropType = data.properties.reduce((acc, prop) => {
    ...
    return acc;
  }, {} as { [key in PropertyType]: AgentPropertyGeneric[] });
...
export const PropertyTable: React.FC<{ transformedData: TransformedProperty[] }> = ({ transformedData }) => {
  return (
